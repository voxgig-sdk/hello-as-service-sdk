...
|---|---|---|
| `ts/` | @voxgig-sdk/hello-as-service-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hello-as-service-sdk \
      --repository voxgig-sdk/hello-as-service-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hello-as-service-sdk` shows it, and
`npm trust revoke @voxgig-sdk/hello-as-service-sdk --id=<id>` removes it.
