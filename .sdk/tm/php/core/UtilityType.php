...
// HelloAsService SDK utility type

class HelloAsServiceUtility
{
    ...
    public static function copy(HelloAsServiceUtility $src): HelloAsServiceUtility
    {
        $u = new HelloAsServiceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
