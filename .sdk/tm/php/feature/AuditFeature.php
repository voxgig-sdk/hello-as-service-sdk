...
// HelloAsService SDK audit feature
...
class HelloAsServiceAuditFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _emit(HelloAsServiceContext $ctx, string $outcome): void
    {
