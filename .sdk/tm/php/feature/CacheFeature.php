...
// HelloAsService SDK cache feature
...
class HelloAsServiceCacheFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _through(HelloAsServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
