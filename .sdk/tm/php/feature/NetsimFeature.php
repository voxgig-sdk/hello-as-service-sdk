...
// HelloAsService SDK netsim feature
...
class HelloAsServiceNetsimFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _simulate(HelloAsServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HelloAsServiceContext $ctx, array $applied): void
    {
        $client = $this->client;
