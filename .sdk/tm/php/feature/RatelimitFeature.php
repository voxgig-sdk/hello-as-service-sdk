...
// HelloAsService SDK ratelimit feature
...
class HelloAsServiceRatelimitFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _acquire(HelloAsServiceContext $ctx): void
    {
    ...
    private function _track(HelloAsServiceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
