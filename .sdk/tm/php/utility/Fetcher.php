...
// HelloAsService SDK utility: fetcher

class HelloAsServiceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HelloAsServiceSDK/1.0)';
    ...
    public static function call(HelloAsServiceContext $ctx, string $fullurl, array $fetchdef): array
    {
