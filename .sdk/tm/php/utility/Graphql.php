...
// HelloAsService SDK utility: graphql
//
...
class HelloAsServiceGraphql
{
    ...
    // equivalent.
    public static function body(HelloAsServiceContext $ctx): mixed
    {
    ...
    public static function errors(HelloAsServiceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
