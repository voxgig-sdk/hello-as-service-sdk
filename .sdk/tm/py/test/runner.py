...
class HelloAsServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HelloAsServiceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HelloAsServiceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HelloAsServiceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
