...
class HelloAsServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HelloAsServiceTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = HelloAsServiceTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = HelloAsServiceTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
