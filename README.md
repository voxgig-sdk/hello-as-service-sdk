...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/hello-as-service` | `npm install @voxgig-sdk/hello-as-service` |
| Python | `voxgig-sdk-hello-as-service` | `pip install voxgig-sdk-hello-as-service` |
| PHP | `voxgig-sdk/hello-as-service` | `composer require voxgig-sdk/hello-as-service` |
| Golang | `github.com/voxgig-sdk/hello-as-service-sdk/go` | `go get github.com/voxgig-sdk/hello-as-service-sdk/go` |
| Ruby | `voxgig-sdk-hello-as-service` | `gem install voxgig-sdk-hello-as-service` |
| Lua | `voxgig-sdk-hello-as-service` | `luarocks install voxgig-sdk-hello-as-service` |
