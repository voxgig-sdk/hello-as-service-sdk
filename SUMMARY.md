...
Results: Successful response with localized greeting.
...
| --- | --- | --- | --- |
| GetGreeting | `load` | `GET /` | See reference |

## Connect to the API

- Production server: `https://hellosalut.stefanbohacek.dev`
...
- `hello-as-service_list`: List records for an entity. No active entity supports this operation.
- `hello-as-service_load`: Load one record for an entity. Supported entities: `get_greeting`.
