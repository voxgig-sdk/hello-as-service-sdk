...
func registerSDKWords(r *eng.Registry, client *sdk.HelloAsServiceSDK) {
...
func runOp(client *sdk.HelloAsServiceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
