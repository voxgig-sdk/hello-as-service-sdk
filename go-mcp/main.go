// Command HelloAsService-mcp is an MCP server exposing the HelloAsService
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HelloAsService_list  — list records of an entity
//	HelloAsService_load  — load a single record of an entity
//
