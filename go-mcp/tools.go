...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_greeting"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HelloAsServiceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "hello-as-service_list",
		Description: "List records from HelloAsService. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "hello-as-service_load",
		Description: "Load a single record from HelloAsService. " +
...
func runOp(client *sdk.HelloAsServiceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HelloAsServiceSDK, name string) (sdk.HelloAsServiceEntity, error) {
	switch strings.ToLower(name) {
	case "get_greeting":
		return client.GetGreeting(nil), nil
