...
func (sdk *HelloAsServiceSDK) OptionsMap() map[string]any {
...
func (sdk *HelloAsServiceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HelloAsServiceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HelloAsServiceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HelloAsServiceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HelloAsServiceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HelloAsServiceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HelloAsServiceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HelloAsServiceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HelloAsServiceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HelloAsServiceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HelloAsServiceSDK {
	...
	sdk := NewHelloAsServiceSDK(sdkopts)
	sdk.Mode = "test"
