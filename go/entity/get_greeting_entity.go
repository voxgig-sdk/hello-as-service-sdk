...
type GetGreetingEntity struct {
	name    string
	client  *core.HelloAsServiceSDK
...
func NewGetGreetingEntity(client *core.HelloAsServiceSDK, entopts map[string]any) *GetGreetingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetGreetingEntity) GetName() string { return e.name }
...
func (e *GetGreetingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetGreetingEntity) Deleted() bool {
	return e.deleted
}


func (e *GetGreetingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetGreetingEntity(e.client, opts)
}

func (e *GetGreetingEntity) Data(args ...any) any {
...
func (e *GetGreetingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetGreeting; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetGreetingEntity) DataTyped(data ...GetGreeting) GetGreeting {
	if len(data) > 0 {
		return typedFrom[GetGreeting](e.Data(asMap(data[0])))
	}
	return typedFrom[GetGreeting](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetGreeting (all fields
// optional at the wire level).
func (e *GetGreetingEntity) MatchTyped(match ...GetGreeting) GetGreeting {
	if len(match) > 0 {
		return typedFrom[GetGreeting](e.Match(asMap(match[0])))
	}
	return typedFrom[GetGreeting](e.Match())
}
...
func (e *GetGreetingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetGreetingEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetGreetingLoadMatch and returns an GetGreeting. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetGreetingEntity) LoadTyped(reqmatch GetGreetingLoadMatch, ctrl map[string]any) (GetGreeting, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetGreeting{}, err
	}
	return typedFrom[GetGreeting](res), nil
}



func (e *GetGreetingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetGreetingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetGreetingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetGreetingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetGreetingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
