...
local GetGreetingEntity = {}
GetGreetingEntity.__index = GetGreetingEntity


function GetGreetingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetGreetingEntity)
  self._name = "get_greeting"
  self._client = client
...
function GetGreetingEntity:get_name()
  return self._name
end


function GetGreetingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetGreetingEntity.new(self._client, opts)
end
...
function GetGreetingEntity:mark_deleted()
  self._deleted = true
end


function GetGreetingEntity:deleted()
  return true == self._deleted
end


function GetGreetingEntity:data_set(args)
  if args ~= nil then
...
function GetGreetingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetGreetingEntity:match_set(args)
  if args ~= nil then
...
function GetGreetingEntity:match_get()
...
function GetGreetingEntity:stream(action, args, callopts)
...
---@param reqmatch GetGreetingLoadMatch
---@param ctrl? table
---@return GetGreeting
---@return string? err
function GetGreetingEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetGreetingEntity:_run_op(ctx, post_done)
  local utility = self._utility
