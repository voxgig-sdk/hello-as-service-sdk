...
describe("GetGreetingDirect", function()
  it("should direct-load-get_greeting", function()
    local setup = get_greeting_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_greeting", setup.live and "live" or "unit")
