# HelloAsService PHP SDK



The PHP SDK for the HelloAsService API — an entity-oriented client using PHP conventions.
...
```
php/
├── helloasservice_sdk.php          -- Main SDK class
...
The main class (`helloasservice_sdk.php`) exports the SDK class
