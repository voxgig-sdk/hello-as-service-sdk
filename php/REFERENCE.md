# HelloAsService PHP SDK Reference

Complete API reference for the HelloAsService PHP SDK.
...
#### `HelloAsServiceSDK::test($testopts = null, $sdkopts = null)`
