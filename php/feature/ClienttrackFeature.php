...
// HelloAsService SDK clienttrack feature
...
class HelloAsServiceClienttrackFeature extends HelloAsServiceBaseFeature
{
    ...
    public function PostConstruct(HelloAsServiceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HelloAsService-SDK';
