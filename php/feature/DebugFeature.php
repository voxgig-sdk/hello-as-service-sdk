...
// HelloAsService SDK debug feature
...
class HelloAsServiceDebugFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _finish(HelloAsServiceContext $ctx, bool $ok): void
    {
