...
// HelloAsService SDK idempotency feature
...
class HelloAsServiceIdempotencyFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _mutating(HelloAsServiceContext $ctx): bool
    {
