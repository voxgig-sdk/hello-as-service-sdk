...
// HelloAsService SDK metrics feature
...
class HelloAsServiceMetricsFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _record(HelloAsServiceContext $ctx, bool $ok): void
    {
