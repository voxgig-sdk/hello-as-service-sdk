...
// HelloAsService SDK paging feature
...
class HelloAsServicePagingFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _is_list(HelloAsServiceContext $ctx): bool
    {
