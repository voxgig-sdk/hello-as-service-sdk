...
// HelloAsService SDK proxy feature
...
class HelloAsServiceProxyFeature extends HelloAsServiceBaseFeature
{
    ...
    public function init(HelloAsServiceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HelloAsServiceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
