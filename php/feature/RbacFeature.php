...
// HelloAsService SDK rbac feature
...
class HelloAsServiceRbacFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _required(HelloAsServiceContext $ctx): ?string
    {
    ...
    private function _reject(HelloAsServiceContext $ctx, string $required): void
    {
    ...
    private function _track(HelloAsServiceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
