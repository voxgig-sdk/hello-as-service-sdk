...
// HelloAsService SDK streaming feature
...
class HelloAsServiceStreamingFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _iterate(HelloAsServiceResult $result): \Generator
    {
    ...
    private function _streamable(HelloAsServiceContext $ctx): bool
    {
