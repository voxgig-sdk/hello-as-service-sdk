...
// HelloAsService SDK telemetry feature
...
class HelloAsServiceTelemetryFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _close(HelloAsServiceContext $ctx, bool $ok): void
    {
