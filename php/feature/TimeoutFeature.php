...
// HelloAsService SDK timeout feature
...
class HelloAsServiceTimeoutFeature extends HelloAsServiceBaseFeature
{
    ...
    private function _with_timeout(HelloAsServiceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HelloAsServiceContext $_ctx, float $ms): void
    {
        $client = $this->client;
