...
class HelloAsServiceSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = HelloAsServiceHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = HelloAsServiceHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!HelloAsServiceFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, HelloAsServiceFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return HelloAsServiceUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = HelloAsServiceHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = HelloAsServiceHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = HelloAsServiceHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new HelloAsServiceError($op . "_allow",
                "HelloAsServiceSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = HelloAsServiceHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new HelloAsServiceError("graphql_error",
                "HelloAsServiceSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetGreeting($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_greeting === null) {
                $this->_get_greeting = new GetGreetingEntity($this, null);
            }
            return $this->_get_greeting;
        }
        return new GetGreetingEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new HelloAsServiceSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
