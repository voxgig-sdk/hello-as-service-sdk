...
class GetGreetingEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HELLO_AS_SERVICE_TEST_GET_GREETING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function get_greeting_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HELLO_AS_SERVICE_TEST_GET_GREETING_ENTID");
