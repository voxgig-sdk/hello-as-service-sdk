...
// HelloAsService SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HelloAsServiceSDK::test)
...
{
    private const SDK_CLASS = 'HelloAsServiceSDK';
    ...
    private const SDK_BASE = 'helloasservice_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../helloasservice_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
