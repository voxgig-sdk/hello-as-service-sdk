...
// HelloAsService SDK utility: make_options

class HelloAsServiceMakeOptions
{
    ...
    public static function call(HelloAsServiceContext $ctx): array
    {
        ...
        //
        // `HelloAsServiceSchema::optspec()` is built from the model:
        ...
        $optspec = HelloAsServiceSchema::optspec();
