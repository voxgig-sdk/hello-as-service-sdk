...
// HelloAsService SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class HelloAsServiceTransformResponse
{
    public static function call(HelloAsServiceContext $ctx): mixed
    {
        ...
        $transform = HelloAsServiceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
