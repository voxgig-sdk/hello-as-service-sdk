...
from helloasservice_sdk.utility import register

# Load features
from helloasservice_sdk.feature.base_feature import HelloAsServiceBaseFeature
from helloasservice_sdk.features import _has_feature, _make_feature
...
class HelloAsServiceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HelloAsServiceUtility()
        self._utility = utility

        from helloasservice_sdk.config import shared_config
    ...
    def get_utility(self):
        return HelloAsServiceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HelloAsServiceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetGreeting(self, data=None) -> "GetGreetingEntity":
        ...
        from helloasservice_sdk.entity.get_greeting_entity import GetGreetingEntity
