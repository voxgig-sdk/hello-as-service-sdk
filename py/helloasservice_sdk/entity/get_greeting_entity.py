...
from helloasservice_sdk.helloasservice_types import (
    GetGreeting,
...
class GetGreetingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetGreetingEntity(self._client, opts)
    ...
    def match_get(self) -> GetGreeting:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetGreeting:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetGreeting().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
