...
class HelloAsServiceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HelloAsServiceTestRunner.getenv("HELLOASSERVICE_TEST_LIVE")
        override = HelloAsServiceTestRunner.getenv("HELLOASSERVICE_TEST_OVERRIDE")
        ...
        explain = HelloAsServiceTestRunner.getenv("HELLOASSERVICE_TEST_EXPLAIN")
