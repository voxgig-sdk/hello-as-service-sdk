# HelloAsService SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HelloAsServiceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HelloAsServiceSDK(...) and HelloAsServiceSDK.test(...) become
#      HelloAsServiceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "helloasservice_sdk"
_SDK_CLASS = "HelloAsServiceSDK"
