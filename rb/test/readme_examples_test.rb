...
#      offline in seeded test mode (HelloAsServiceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HelloAsService_sdk.rb")
  SDK_CLASS = "HelloAsServiceSDK"
