...
(0, node_test_1.describe)('GetGreetingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HelloAsServiceSDK({
    ...
    (0, node_test_1.test)('direct-load-get_greeting', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_greeting', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HELLO_AS_SERVICE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HelloAsServiceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['HELLO_AS_SERVICE_TEST_GET_GREETING_ENTID'];
    ...
    const client = new __1.HelloAsServiceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetGreetingDirect.test.js.map