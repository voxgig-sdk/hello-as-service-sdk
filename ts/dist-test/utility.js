...
function envOverride(m) {
    if ('TRUE' === process.env.HELLO_AS_SERVICE_TEST_LIVE ||
        'TRUE' === process.env.HELLO_AS_SERVICE_TEST_OVERRIDE) {
    ...
    m.HELLO_AS_SERVICE_TEST_EXPLAIN = process.env.HELLO_AS_SERVICE_TEST_EXPLAIN || m.HELLO_AS_SERVICE_TEST_EXPLAIN;
    return m;
}
